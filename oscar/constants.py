...
# Display
TILES_VISIBLE_ON_SCREEN_WIDTH = 21  # this value now control the pysc2 behavior no need of reverse engineering anymore
SCREEN_RESOLUTION = 84
MINIMAP_RESOLUTION = SCREEN_RESOLUTION
TILES_SIZE_IN_CELL = SCREEN_RESOLUTION / TILES_VISIBLE_ON_SCREEN_WIDTH
